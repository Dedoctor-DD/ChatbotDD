        ...
        <nav className={`fixed w-full z-[100] transition-all duration-500 py-6 px-4 md:px-12 ${isScrolled ? 'top-0' : ''}`}>
            <div className={`max-w-7xl mx-auto glass-nav rounded-3xl px-8 py-5 flex justify-between items-center transition-all ${isScrolled ? 'shadow-xl shadow-blue-900/5' : 'shadow-sm'}`}>
                ...
                <div className="hidden lg:flex items-center gap-10 font-bold text-[11px] uppercase tracking-widest text-slate-500">
                    ...
                    <button onClick={onLoginClick} className="hover:text-blue-600 transition-colors ml-4">Acceso</button>
                </div>
        ...
        {partners.length > 0 && (
          <section className="py-20 bg-white border-y border-slate-50 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-12 text-center">Empresas que confían en nosotros</p>
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center gap-12">
                    ...
                    <div className="flex gap-12 text-slate-500 font-bold text-xs uppercase tracking-widest">
                        <a href="#" className="hover:text-blue-600 transition-colors">Seguridad</a>
                        <button onClick={onLoginClick} className="hover:text-blue-600 transition-colors uppercase font-bold text-xs">Admin</button>
                    ...
                    <div className="flex gap-4">
                        ...
                        <a href="https://wa.me/123456789" className="w-12 h-12 bg-green-50 rounded-2xl flex items-center justify-center text-green-500 hover:bg-green-100 transition-all shadow-sm"><i className="fab fa-whatsapp"></i></a>
                    </div>
                </div>
