...
export function BottomNav({ activeTab, onTabChange, isAdmin, onNewChat }: BottomNavProps) {
  ...
  return (
    <nav className="w-full max-w-md md:max-w-2xl mx-auto bg-white/95 dark:bg-surface-dark/95 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 pb-[env(safe-area-inset-bottom)] z-[70] md:rounded-b-[3rem] sticky bottom-0">
      {/* Arise Sub-menu */}
      {showAriseMenu && (
