    ...
    return (
        <div className="flex flex-col w-full min-h-full bg-background-light dark:bg-background-dark pb-24">
            <header className="px-6 pt-12 pb-6">
                <h1 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Centro de <span className="text-primary">Ayuda</span></h1>
            ...
            <main className="px-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <a 
                        ...
                        className="bg-white dark:bg-surface-dark p-6 rounded-[2rem] shadow-xl shadow-blue-500/5 border border-gray-50 dark:border-gray-800 flex flex-col items-center gap-3 active:scale-95 transition-all text-center no-underline"
                    >
                        <div className="w-12 h-12 bg-blue-50 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center text-primary">
                            <Phone className="w-6 h-6" />
                        </div>
                        <span className="text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Llamar Soporte</span>
                    </a>
                    ...
                    >
                        ...
                        <span className="text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">WhatsApp Directo</span>
                    </a>
                </div>
                ...
                <section className="bg-white dark:bg-surface-dark rounded-[2.5rem] p-8 shadow-2xl shadow-gray-200/50 dark:shadow-none border border-gray-50 dark:border-gray-800">
                    ...
                    {formStatus === 'success' ? (
                        <div className="py-8 text-center animate-scale-in">
                            ...
                            <h4 className="text-lg font-black text-gray-900 dark:text-white mb-2">¡Mensaje Enviado!</h4>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-1">
                                ...
                                <input 
                                    required
                                    className="w-full bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4 text-sm font-bold text-gray-800 dark:text-white focus:ring-2 focus:ring-primary/20 outline-none transition-all" 
                            ...
                            <div className="space-y-1">
                                ...
                                <textarea 
                                    required rows={4}
                                    className="w-full bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-4 text-sm font-bold text-gray-800 dark:text-white focus:ring-2 focus:ring-primary/20 outline-none transition-all resize-none" 
